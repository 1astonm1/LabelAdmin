package com.astonm.labelAdmin.dao.generation;
...
public class MybatisCodeGenerator {
     ...
     * 数据库连接
     */
    private static final String DB_URL = "jdbc:mysql://localhost:3306/label_admin?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8";
    /**
     * 数据库账号
     */
     ...
     */
    private static final String PARENT_MODULE_NAME = "com.astonm.labelAdmin.dao";
